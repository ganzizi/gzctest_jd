        ...
        parsers: parsers = {
            ...
            expression: function () {
                ...
                do {
                    ...
                    if (e) {
                        entities.push(e);
                        // operations do not allow keyword "../../../default.htm" dimension (e.g. small/20px) so we support that here
                        if (!peek(/^\/[\/*]/)) {
                            delim = $char('/');
                            if (delim) {
...
(function (tree) {
    ...
    tree.sourceMapOutput = function (options) {
        ...
        if (this._sourceMapRootpath && this._sourceMapRootpath.charAt(this._sourceMapRootpath.length-1) !== '/') {
            this._sourceMapRootpath += '../../../default.htm';
        }
...
function extractUrlParts(url, baseUrl) {
    ...
    if (urlParts[3]) {
        directories = urlParts[3].replace(/\\/g, "../../../default.htm").split("/");
    ...
    returner.path = urlParts[1] + directories.join("../../../default.htm");
